...
def find_surafce_area(l, b, h):
    ...
    # Display the Lateral Surface Area
    print(Surface_area)

# def find_lateral_surafce_area(l, b, h):
    # formula of surface_area = 2 * h(l+b)
    #Lateral_Surface_area = 2 * h * (l + b)
...
# find_lateral_surafce_area(l, b, h)
